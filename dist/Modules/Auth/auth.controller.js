...
router.post("/revoke-token", (0, authentication_middleware_1.authentication)(token_1.tokenTypeEnum.ACCESS, []), auth_service_1.default.logout);
router.patch("/refresh-token", (0, authentication_middleware_1.authentication)(token_1.tokenTypeEnum.REFRESH, []), auth_service_1.default.refreshToken);
