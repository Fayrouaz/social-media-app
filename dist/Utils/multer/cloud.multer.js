...
exports.cloudFileUplaod = exports.validationFile = exports.StorageEnum = void 0;
...
const cloudFileUplaod = ({ validation = [], storageApproch = StorageEnum.MEMORY, maxSizeMB = 2 }) => {
    ...
    function fileFilter(req, file, cb) {
        if (!validation.includes(file.mimetype)) {
            throw new error_response_1.BadRequestExpetion("Invaild File Type");
        }
        return cb(null, true);
    }
    return (0, multer_1.default)({ fileFilter, limits: { fileSize: maxSizeMB * 1024 * 1024 }, storage });
};
exports.cloudFileUplaod = cloudFileUplaod;
